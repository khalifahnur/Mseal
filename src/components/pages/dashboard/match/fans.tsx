...
export function FanFacts() {
    ...
    const fanFacts = [
    {
      ...
      content: "Thunder FC's striker has scored 12 goals this season, making him the league's second-highest scorer.",
      icon: Trophy,
    ...
    },
    {
      ...
      content: "Thunder FC has won 8 out of their last 10 home games this season with an impressive 80% win rate.",
      icon: TrendingUp,
    ...
    },
    {
      ...
      content: "In their last 5 meetings, Thunder FC leads 3-2, but Lightning United won the most recent encounter.",
      icon: Users,
      color: "text-blue-500",
      bgColor: "bg-blue-50",
    },
    {
      title: "Fan Favorite",
      content: "Lightning United's midfielder was voted 'Player of the Month' by fans with 67% of the votes.",
      icon: Star,
    ...
    },
    {
      ...
      content: "This match could see Lightning United's goalkeeper break the clean sheet record for the season.",
      icon: Zap,
