    ...
    >
      <SheetTrigger asChild>
        ...
        >
          ...
          {totalItems ? (
            <div className="absolute right-0 top-0 -mr-2 -mt-2 h-5 w-4 rounded-sm bg-red-500 text-[11px] font-medium text-white place-items-center">
              <p className="text-sm items-center ">{totalItems}</p>
            </div>
          ) : null}
        </div>
      </SheetTrigger>
